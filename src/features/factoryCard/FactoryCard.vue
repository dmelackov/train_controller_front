<template>
    <div class="factory">
        ...
        <hr>
        <div class="factory__buffer_list" v-if="factory_info">
        ...
        <hr>
        <div class="factory__station_list" v-if="factory_info">
            <StationInventoryCard v-for="buf in factory_config.tracks" :key="buf.station_uuid"
                :inventory_name="buf.train_inventory" :factory_uuid="factory_config.uuid"
